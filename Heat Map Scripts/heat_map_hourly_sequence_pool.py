...
for dir in glob.glob('/media/nipek/My Book/Rabbit Research Videos/WP 3.2/C*'):
    ...
    mask_path = os.path.join('/media/nipek/My Book/Rabbit Research Videos/WP 3.2/Analysis/Final_Masks',
                             (camera_text.replace(' ', '_') + '_mask.jpg'))
    ...
    for vid in glob.glob(dir + '/*'):
        ...
        argument_arr.append(
            (vid, mask_np, os.path.join(heatmap_path, (vid_name + '.npy')), crop_parameters[camera_text], vid_name))
