...
for dir in glob.glob('/media/ricky/My Book/Rabbit Research Videos/WP 3.2/C*'):
    ...
    cv2.imwrite('/media/ricky/My Book/Rabbit Research Videos/WP 3.2/Analysis/Camera_' + camera_number + '_initial' + '.jpg', image)
...
for dir in glob.glob('/media/ricky/My Book/Rabbit Research Videos/WP 3.2/C*'):
    ...
    cv2.imwrite('/media/ricky/My Book/Rabbit Research Videos/WP 3.2/Analysis/Camera_' + camera_number + '_cropped' + '.jpg', image)
