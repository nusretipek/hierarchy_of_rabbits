...
json_dump_file_location = "../Tracking/Action_Videos/random_action_videos/Action_c_019_dev_classified.json"
vid_in_file_location = "../Tracking/Action_Videos/random_action_videos/Action_c_019.mp4"
vid_out_file_location = "../Tracking/Action_Videos/random_action_videos/Tracker_Final_Action_Action_c_019_dev.mp4"
print(json_dump_file_location)
output_image = False
    ...
    if success:
        ...
        for track_id in range(rabbit_tracker.n_obj):
            ...
            if tracks[str(track_id)][str(counter)]['point'] is not None:
                ...
                frame = cv2.putText(frame, "Doe " + str(track_id) + " - " + shape_arr[track_id],
