...
for directory in sorted(glob.glob('/media/nipek/My Book/Rabbit Research Videos/WP 3.2/C*')):
    camera_text = directory.rsplit('/', 1)[1]
    action_diagram_path = os.path.join('/media/nipek/My Book/Rabbit Research Videos/WP 3.2/Analysis/Action_Diagrams',
                                       camera_text)
    ...
    master_df.to_excel('/media/nipek/My Book/Rabbit Research Videos/WP 3.2/Analysis/Action_Diagrams/Action_Moments_Excel_Recommender/' + camera_text + '.xlsx', index=False)
