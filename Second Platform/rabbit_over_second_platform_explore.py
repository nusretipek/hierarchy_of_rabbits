...
def platform_usage_wp2_test(vid, crop_parameters, platform_parameters, minute, second):
...
def platform_usage_wp3_test_3(vid, crop_parameters, minute, second):
    cap = cv2.VideoCapture(vid)
...
platform_usage_wp3_test_3('/media/nipek/My Book/Rabbit Research Videos/WP 3.1 - ILVO/Cycle 1/kon01.20200902_070000.mp4',
                          [325, 460, 580, 700], 0, 0, 40,
                          '/media/nipek/My Book/Rabbit Research Videos/WP 3.2/Analysis/Rabbit_Over_Platform/Masks/Camera_5.jpg')


# [340, 470, 15, 145]
# [325, 460, 580, 700] #Rabbit
