...
for dir in glob.glob('/media/nipek/My Book/Rabbit Research Videos/WP 3.2/Analysis/Heatmaps/C*'):
    ...
    station_1_image = sample_arr[station_1_crop_params[2]:station_1_crop_params[3],
                                 station_1_crop_params[0]:station_1_crop_params[1]]
    station_2_image = sample_arr[station_2_crop_params[2]:station_2_crop_params[3],
                                 station_2_crop_params[0]:station_2_crop_params[1]]
    cv2.imwrite('/media/nipek/My Book/Rabbit Research Videos/WP 3.2/Analysis/Feeding_Station_Crop_Check/Camera_' + camera_number + '_feeding_station_1' + '.jpg', station_1_image * 255)
    cv2.imwrite('/media/nipek/My Book/Rabbit Research Videos/WP 3.2/Analysis/Feeding_Station_Crop_Check/Camera_' + camera_number + '_feeding_station_2' + '.jpg', station_2_image * 255)
